            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php if(isset($active2)){echo $active2;}?>">
                        <a href="tickets.php"><i class="fa fa-file-text-o"></i> Solicitudes</a>
                    </li>

                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="projects.php"><i class="fa fa-taxi"></i> Tipo de autos</a>
                    </li>

                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="categories.php"><i class="fa fa-bus"></i> Marca de Autos</a>
                    </li>
                    ...
                    <li class="<?php if(isset($active6)){echo $active6;}?>">
                        <a href="users.php"><i class="fa fa-users"></i> Pilotos</a>
                    </li>
<!--
